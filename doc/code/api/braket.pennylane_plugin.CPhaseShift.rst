...
.. autoclass:: CPhaseShift
   ...
   .. autosummary::
      ...
      ~CPhaseShift.base_name
      ~CPhaseShift.do_check_domain
      ~CPhaseShift.eigvals
      ~CPhaseShift.generator
      ~CPhaseShift.grad_method
      ~CPhaseShift.grad_recipe
      ~CPhaseShift.inverse
      ~CPhaseShift.matrix
      ~CPhaseShift.name
      ~CPhaseShift.num_params
      ~CPhaseShift.num_wires
      ~CPhaseShift.par_domain
      ~CPhaseShift.parameters
      ~CPhaseShift.string_for_inverse
      ~CPhaseShift.wires
   ...
   .. autosummary::
      ...
      ~CPhaseShift.check_domain
      ~CPhaseShift.decomposition
      ~CPhaseShift.get_parameter_shift
      ~CPhaseShift.inv
      ~CPhaseShift.queue
